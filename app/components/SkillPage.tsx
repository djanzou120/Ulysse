...
const SkillPage = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full md:gap-y-10 gap-y-7 ">
            ...
            <div id="workTogether" className="flex flex-row items-center gap-x-12 mt-10 relative w-72">
                <span className="uppercase font-medium underline underline-offset-10 decoration-green-600">travaillons ensemble</span>
                <div className="bg-green-600 rounded-full dark:text-black text-white text-5xl p-1 workTogether absolute right-0 cursor-pointer dark:hover:text-green-600 hover:text-green-600 hover:border-green-600 dark:hover:bg-black hover:border-2 hover:bg-white transition duration-300">
                    <BiChevronRight/>
                </div>
            </div>
        </div>
